          ...
          {ORDER.map((cat) => {
            ...
            return (
              <a
                key={cat}
                href={`#${cat}`}
                className="inline-block px-3 py-2 font-mono text-[11px] uppercase tracking-tracked text-muted underline-offset-4 transition-colors hover:text-accent-strong"
              >
                {CATEGORY_TITLES[cat]}
              </a>
            );
